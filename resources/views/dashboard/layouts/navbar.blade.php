        ...
        <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
          ...
          <div class="grid grid-cols-3 gap-4 p-4">
            <a href="/" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
              ...
              <div class="text-sm font-medium text-gray-900 dark:text-white">Frontend</div>
            </a>
            <a href="/dashboard/profile" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
              ...
              <div class="text-sm font-medium text-gray-900 dark:text-white">Profil</div>
            </a>
            <form method="POST" action="{{ route('logout') }}">
              @csrf
              <a class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600" :href="route('logout')" onclick="event.preventDefault();
                                                this.closest('form').submit();">
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12H4m12 0-4 4m4-4-4-4m3-4h2a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3h-2" />
                </svg>
                <div class="text-sm font-medium text-gray-900 dark:text-white">Log Out</div>
              </a>
            </form>
          </div>
        </div>
